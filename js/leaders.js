...
const LEADERS = {
  ...
  umayyad: [
    ...
    // --- قادة الأحداث ---
    L('سولوك أبو مزاحم', 'event', 'cavalier', null, [2, 2, 1, 1], 'notable', [717, 738], 'Suluk_(Türgesh_khagan)', null, 'خاقان الترغش الذي قاتل الأمويين في ما وراء النهر، وسمّته المصادر العربية «أبا مزاحم». قُتل سنة 738.'),
