...
const HELP = {
  ...
  income: { t: 'الدخل', icon: 'coins', what: 'ذهب هذه المدينة كل دور.', up: 'السكان، الأسواق، الولاء، الضرائب، حاكم إداري.', down: 'الحصار، الاضطراب، الازدحام، الفساد في الممالك الكبيرة.', eff: 'يدفع رواتب الجيوش والمشاريع.' },
