...
const BUILDINGS = {
  // upkeep: صيانة المستوى الحالي كل دور. الحصون والإسطبلات والموانئ تحتاج رجالاً ومواد لتبقى صالحة
  walls: { name: 'أسوار', icon: 'wall', max: 4, cost: (lvl) => [180, 300, 450, 750][lvl], upkeep: (lvl) => [0, 0, 3, 7, 12][lvl], desc: 'تفرض الحصار وتضاعف كلفة الاقتحام. الرابع قلعة عظمى. الأسوار الحجرية فما فوق تحتاج صيانة.' },
  market: { name: 'سوق', icon: 'market', max: 3, cost: (lvl) => [150, 300, 550][lvl], upkeep: () => 0, desc: '+40٪ دخل لكل مستوى، وتجارة أكثر' },
  farm: { name: 'مزارع', icon: 'farm', max: 2, cost: (lvl) => [120, 240][lvl], upkeep: () => 0, desc: '+6 طعام، سكان وقوى بشرية أكثر' },
  granary: { name: 'مخازن', icon: 'granary', max: 2, cost: (lvl) => [140, 280][lvl], upkeep: (lvl) => lvl, desc: '+3 أدوار صمود في الحصار، +3 سعة إمداد' },
  barracks: { name: 'إسطبلات وورش', icon: 'horseshoe', max: 1, cost: () => 220, upkeep: (lvl) => (lvl ? 3 : 0), desc: 'تتيح الخيالة والمنجنيق، وتدريب الجيوش المقيمة وإعادة تسليحها' },
  roads: { name: 'طرق معبّدة', icon: 'road', max: 1, cost: () => 260, upkeep: (lvl) => (lvl ? 2 : 0), desc: 'الحركة من المدينة وإليها أرخص بنقطة، وتجارة أكثر' },
  port: { name: 'ميناء', icon: 'ship', max: 1, cost: () => 280, upkeep: (lvl) => (lvl ? 3 : 0), coastal: true, desc: 'يفتح الطرق المائية لكل جيوشك من هنا، ويزيد التجارة' },
};
...
const HELP = {
  ...
  upkeep: { t: 'كلفة الجيوش', icon: 'swords', what: 'ما تدفعه كل دور: صيانة الوحدات ورواتب القادة والحكّام، وصيانة الحصون والإسطبلات والموانئ.', up: 'المرتزقة (ضعف تقريباً)، الجيوش في أرض العدو أو في الحصار (+35٪ تموين)، القادة الطمّاعون، الجيوش الزائدة عن عدد مدنك، الأسوار الحجرية فما فوق.', down: 'التسريح، إعفاء القادة، إعادة الجيوش إلى أرضك.', eff: 'الحصار الطويل بعيداً عن أرضك يكلّف أكثر مما يبدو. الجيش الذي لا يعمل يأكل الخزينة.' },
